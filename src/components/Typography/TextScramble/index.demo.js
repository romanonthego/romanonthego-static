...
export const description = (
  <React.Fragment>
    ...
    <TextPrint component="p">
      React pure component for text scramble effect. Highly effective, only render what it absolutly needs to. Utilises
      `requestAnimationFrame` under the hood. Reworked to react component from
    </TextPrint>
    <LinkPrint to="https://codepen.io/soulwire/pen/mErPAK">Text Scramble Effect codepen</LinkPrint>
  </React.Fragment>
);
